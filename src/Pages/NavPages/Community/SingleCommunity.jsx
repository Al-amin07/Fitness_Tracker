...
const SingleCommunity = ({item}) => {
    ...
    return (
        ...
        <div className="p-3">
          ...
          <button onClick={() => setUpVote(upVote + 1)} className="border-r-2 border-slate-400 pr-3"> <FaArrowUp className="text-xl font-bold inline-block"/><span className={` ${upVote > 0 ? 'inline-block' : 'hidden'}`}>Up Vote {upVote}</span></button>
