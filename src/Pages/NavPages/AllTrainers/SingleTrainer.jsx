...
const SingleTrainer = ({trainer}) => {
    const {full_name, email, age, years_of_experience,profile_image, available_slots, skills } = trainer
    return (
        <div className="overflow-hidden rounded bg-white text-slate-500 shadow-xl shadow-slate-200">
        {/*  <!-- Image --> */}
