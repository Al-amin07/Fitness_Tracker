    ...
    <div>
      ...
      >
        {testimonials.map((test) => (
          <SwiperSlide key={test._id} data-hash="slide1">
            {" "}
            <div className="h-full overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200">
              <div className="relative p-6">
                <figure className="relative z-10">
                  ...
                  <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-cyan-500">
                    <Rating
                      style={{ 
                        maxWidth: 180,
                      ...
                      readOnly
                    />
                    <div className=" flex justify-center pt-2 text-sm text-cyan-500">
                    
                      <div className="flex flex-col gap-1">
                        <span className="font-bold uppercase">{test.name}</span>
                        <cite className="not-italic">
                          <a href='#'>{test.profession}</a>
                        </cite>
                      </div>
                    </div>
                  </figcaption>
