...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-[#2B3440] text-white">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            <div className="lg:w-1/3">
                <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                    ...
                    <span className="self-center text-2xl font-semibold">Fitness<sup className="text-cyan-500">Synced</sup></span>
                </a>
            </div>
        ...
        <div className="py-6 text-sm text-center dark:text--600">© 1968 Company Co. All rights reserved.</div>
    </footer>
    );
};
