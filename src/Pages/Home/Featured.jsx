...
const Featured = () => {
    return (
        ...
        <div className="container mx-auto p-4 mb-8 space-y-2 text-center">
            <h2 className="text-3xl md:text-4xl  lg:text-5xl font-semibold">Key Features of Our Fitness Tracker</h2>
            <p className="dark:text-gray-600 md:w-3/4 mx-auto mt-2">Explore the innovative features that make our fitness tracker the perfect companion for your health and wellness journey. Each feature is designed to enhance your experience and help you reach your goals with ease.</p>
        </div>
        <div className="container mx-auto grid justify-center  sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="flex flex-col items-center p-6 border-b-2  border-cyan-600">
                ...
                <h3 className="my-3 text-2xl  md:text-3xl font-semibold">Real-Time Tracking</h3>
            ...
            <div className="flex flex-col items-center p-6 md:border-l-2 lg:border-x-2 border-b-2 border-cyan-600">
                <IoMdPerson className="text-4xl"/>
                <h3 className="my-3 text-2xl  md:text-3xl  font-semibold">Personalized Insights</h3>
                <div className="space-y-1 leading-tight">
            ...
            <div className="flex flex-col items-center p-6 border-b-2 border-cyan-600">
             <LuGoal className='text-4xl'/>
                <h3 className="my-3 text-2xl  md:text-3xl  font-semibold">Goal Setting</h3>
                <div className="space-y-1 leading-tight">
            ...
            <div className="flex flex-col md:border-l-2 lg:border-l-0 md:border-b-2  lg:border-b-0 border-cyan-600 items-center p-6">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-9 h-9 dark:text-violet-600">
                    <path fillRule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z" clipRule="evenodd"></path>
                </svg>
                <h3 className="my-3 text-2xl  md:text-3xl  font-semibold">Activity History</h3>
                <div className="space-y-1 leading-tight">
            ...
            <div className="flex flex-col items-center border-t-2 md:border-t-0 p-6 md:border-l-0 lg:border-l-2 border-x-0 lg:border-x-2 border-cyan-600">
              <BiSolidCustomize className="text-4xl"/>
                <h3 className="my-3 text-2xl  md:text-3xl font-semibold">Customizable Workouts</h3>
                <div className="space-y-1 leading-tight">
            ...
            <div className="flex flex-col md:border-l-2 border-cyan-600 lg:border-l-0 border-t-2 md:border-t-0 items-center p-6 ">
               <ImSleepy2 className="text-4xl"/>
                <h3 className="my-3 text-2xl  md:text-3xl  font-semibold"> Sleep Monitoring</h3>
                <div className="space-y-1 leading-tight">
