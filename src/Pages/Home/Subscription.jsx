...
const Subscription = () => {
  ...
  return (
    <section className="bg-cyan-50 dark:text-gray-800">
      <div className="container  flex flex-col-reverse  md:flex-row p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between px-6 md:px-12 lg:px-16">
        <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
          ...
          <div className="relative  my-6 inline-flex w-full flex-row-reverse items-center rounded  text-bg text-slate-500">
              <input
                id="email"
                name="email"
                type="email"
                placeholder="Your Email"
                className="peer order-2 text-bg px-4 w-full py-3 border rounded-l-full"
              />
